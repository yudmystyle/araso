...
[CustomEditor(typeof(Demo2Controller))]
public class QMeTwoInspector : Editor
{
    ...
    SerializedProperty LevelText = null;
    SerializedProperty ProgressBar = null;
    SerializedProperty CorrectAnswersLeft = null;
    SerializedProperty SoundButton = null;
    SerializedProperty VibrateButton = null;
    SerializedProperty AdExperienceButton = null;

    SerializedProperty CategoryName = null;
    SerializedProperty CategoryDisplay = null;
    SerializedProperty CategoryGroup = null;
    SerializedProperty ErrorPanel = null;
    SerializedProperty Loading = null;
    SerializedProperty PickButton = null;
    SerializedProperty RetryButton = null;
    SerializedProperty PlayButton = null;
    SerializedProperty RetryAdPanel = null;
    ...
    void OnEnable()
    {
        ...
        CorrectAnswersLeft = serializedObject.FindProperty("CorrectAnswersLeft");
        ...
        CategoryDisplay = serializedObject.FindProperty("CategoryDisplay");
        ...
        PickButton = serializedObject.FindProperty("PickButton");
        RetryButton = serializedObject.FindProperty("RetryButton");
        PlayButton = serializedObject.FindProperty("PlayButton");
        RetryAdPanel = serializedObject.FindProperty("RetryAdPanel");
    ...
    public override void OnInspectorGUI()
    {
        ...
        GUILayout.BeginHorizontal();
        {
            ...
            GUILayout.BeginVertical();
            {
                ...
                string Demo = "<size=11>" + "Demo Two" + "</size>";
        ...
        //        if (!File.Exists("Assets\\Plugins\\iOS\\iOSNativeShare.h") || (!File.Exists("Assets\\Plugins\\iOS\\iOSNativeShare.m")))
        //        {
        //            GUILayout.Space(5);
        //            GUILayout.BeginHorizontal();
        //            GUILayout.FlexibleSpace();
        //            if (GUILayout.Button("Import iOS Plugins", GUILayout.Height(30), GUILayout.Width(200)))
        //                AssetDatabase.ImportPackage("Assets\\Trivia 365\\iOS Native Share Plugins.unitypackage", true);
        //            GUILayout.FlexibleSpace();
        //            GUILayout.EndHorizontal();
        //        }
        ...
        if (ShowAdmob)
        {
			...
			if (GUILayout.Button("Enable Admob Ads", GUILayout.Height(20)))
			{
				var option = EditorUtility.DisplayDialogComplex(
					             "Enable Admob Ads",
					             "Have you imported the Admob Unity Plugin?",
					             "Yes",
					             "No",
					             "Cancel");
				switch (option)
        ...
        if (ProfileButton.isExpanded)
        {
            ...
            EditorGUILayout.PropertyField(CorrectAnswersLeft);
        ...
        if (CategoryGroup.isExpanded)
        {
            ...
            EditorGUILayout.PropertyField(PickButton);
            EditorGUILayout.PropertyField(RetryButton);
            EditorGUILayout.PropertyField(PlayButton);
            EditorGUILayout.PropertyField(RetryAdPanel);
        }
